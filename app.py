...
groq_key = st.sidebar.text_input("مفتاح Groq API Key:", value="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", type="password")
...
if st.button("🚀 بدء دورة البحث المزدوج والتحكيم الثلاثي الشامل", type="primary"):
    if not groq_key or not gemini_key:
        ...
        with st.spinner("⏳ جاري الزحف في المنصات الأكاديمية واستدعاء مصفوفة النماذج الثلاثية..."):
            ...
            prompt = f"أنت خبير التحكيم الأكاديمي واكتشاف الفجوات العلمية.\n\nالموضوع: {research_title}\nالميدان: {research_field}\n\nالأوراق المسترجعة:\n{papers_summary}\n\nالمطلوب:\n1. مصفوفة الإطباق المنهجي.\n2. استخراج 3 فجوات بحثية نوعية ومخصصة للموضوع.\n3. صياغة مسودة بحثية متكاملة تشمل المقدمة، الإشكالية، 3 فرضيات، والمنهجية المقترحة."
            ...
            st.success("🎉 اكتمل التحكيم المقارن متعدد النماذج بنجاح تام!")
